...
public class UnequipWeapon {
    ...
    public void theInventoryItemIsAvailableAndItSAEquippedWeapon() {
    ...
    public void thePlayerUnequipsTheWeapon() {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.set("Content-Type", "application/json");

            response = new RestTemplate().exchange(BASE_URL + port + "/api/inventoryItems/" + inventoryItem.getId() + "/unequipWeapon", HttpMethod.PUT, null, String.class);
